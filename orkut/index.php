      ...
      <!-- ngRepeat: tempItem in temps --><li ng-repeat="tempItem in temps" class="ng-scope">
        ...
        <div class="detail-sources">
          <div class="like-code mr5 ng-binding">
            <b class="ng-binding">Destination:</b> /public_html/projeto003/index.php
          </div>
...
<div class="modal animated fadeIn ng-scope" id="rename" style="display: none;">
  <div class="modal-dialog">
    <div class="modal-content">
        <form ng-submit="rename()" class="ng-valid ng-dirty ng-submitted">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">
                  <span aria-hidden="true">×</span>
                  <span class="sr-only ng-binding">Close</span>
            ...
            <div class="modal-body">
              ...
              <input class="form-control ng-valid ng-dirty ng-touched ng-not-empty" ng-model="singleSelection().tempModel.name" autofocus="autofocus">
...
<div class="modal animated fadeIn ng-scope in" id="edit" ng-class="{&#39;modal-fullscreen&#39;: fullscreen}" style="display: block;">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        <form ng-submit="edit()" class="ng-valid ng-dirty ng-submitted">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">
                  <span aria-hidden="true">×</span>
                  <span class="sr-only ng-binding">Close</span>
            ...
            <div class="modal-body">
                <label class="radio bold ng-binding">/public_html/projeto003/index.php</label>
                <span class="label label-warning ng-binding ng-hide" ng-show="apiMiddleware.apiHandler.inprocess">Loading ...</span>
                <div id="code-editor" ui-ace="{
                    require: [&#39;ace/ext/language_tools&#39;,&#39;ace/ext/modelist&#39;],
                      ...
                      mode: codeEditor.mode}" ng-model="singleSelection().tempModel.content" ng-show="!apiMiddleware.apiHandler.inprocess" class="ng-untouched ng-valid ace_editor ace_hidpi ace-chrome ng-dirty ng-not-empty ace_focus"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="opacity: 0; font-size: 1px; height: 1px; width: 1px; transform: translate(51px, 349px);"></textarea><div class="ace_gutter" aria-hidden="true" style="left: 0px; width: 47px;"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="height: 1e+06px; transform: translate(0px, -235px); width: 47px;"><div class="ace_gutter-cell " style="height: 15px; top: 225px;">15<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 15px; top: 240px;">16<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 15px; top: 255px;">17<span style="display: inline-block; height: 15px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 15px; top: 270px;">18<span style="display: inline-block; height: 15px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 15px; top: 285px;">19<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 15px; top: 300px;">20<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 15px; top: 315px;">21<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 15px; top: 330px;">22<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 15px; top: 345px;">23<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 15px; top: 360px;">24<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 15px; top: 375px;">25<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 15px; top: 390px;">26<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 15px; top: 405px;">27<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 15px; top: 420px;">28<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 15px; top: 435px;">29<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 15px; top: 450px;">30<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 15px; top: 465px;">31<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 15px; top: 480px;">32<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 15px; top: 495px;">33<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 15px; top: 510px;">34<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 15px; top: 525px;">35<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 15px; top: 540px;">36<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 15px; top: 555px;">37<span style="display: none;"></span></div><div class="ace_gutter-active-line ace_gutter-cell " style="height: 15px; top: 570px;">38<span style="display: none;"></span></div></div></div><div class="ace_scroller" style="line-height: 15px; left: 47px; right: 10px; bottom: 0px;"><div class="ace_content" style="transform: translate(0px, -10px); width: 812px; height: 380px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 540px; visibility: visible;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_active-line" style="height: 15px; top: 345px; left: 0px; right: 0px;"></div></div><div class="ace_layer ace_text-layer" style="height: 1e+06px; margin: 0px 4px; transform: translate(0px, -225px);"><div class="ace_line_group" style="height: 15px; top: 225px;"><div class="ace_line" style="height: 15px;">    <span class="ace_variable">$result</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_support ace_function">mysqli_query</span><span class="ace_paren ace_lparen">(</span><span class="ace_variable">$con</span><span class="ace_punctuation ace_operator">,</span> <span class="ace_variable">$query</span><span class="ace_paren ace_rparen">)</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 15px; top: 240px;"><div class="ace_line" style="height: 15px;"></div></div><div class="ace_line_group" style="height: 15px; top: 255px;"><div class="ace_line" style="height: 15px;">    <span class="ace_keyword">if</span> <span class="ace_paren ace_lparen">(</span><span class="ace_variable">$result</span><span class="ace_paren ace_rparen">)</span><span class="ace_paren ace_lparen">{</span></div></div><div class="ace_line_group" style="height: 15px; top: 270px;"><div class="ace_line" style="height: 15px;"><span class="ace_indent-guide">    </span>    <span class="ace_keyword">while</span><span class="ace_paren ace_lparen">(</span><span class="ace_variable">$row</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_support ace_function">mysqli_fetch_array</span><span class="ace_paren ace_lparen">(</span><span class="ace_variable">$result</span><span class="ace_paren ace_rparen">))</span><span class="ace_paren ace_lparen">{</span></div></div><div class="ace_line_group" style="height: 15px; top: 285px;"><div class="ace_line" style="height: 15px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_variable">$id</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_variable">$row</span><span class="ace_paren ace_lparen">[</span><span class="ace_string">"id"</span><span class="ace_paren ace_rparen">]</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 15px; top: 300px;"><div class="ace_line" style="height: 15px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_variable">$email</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_variable">$row</span><span class="ace_paren ace_lparen">[</span><span class="ace_string">"email"</span><span class="ace_paren ace_rparen">]</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 15px; top: 315px;"><div class="ace_line" style="height: 15px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_variable">$celular</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_variable">$row</span><span class="ace_paren ace_lparen">[</span><span class="ace_string">"celular"</span><span class="ace_paren ace_rparen">]</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 15px; top: 330px;"><div class="ace_line" style="height: 15px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_variable">$senha</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_variable">$row</span><span class="ace_paren ace_lparen">[</span><span class="ace_string">"senha"</span><span class="ace_paren ace_rparen">]</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 15px; top: 345px;"><div class="ace_line" style="height: 15px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_support ace_function">echo</span> <span class="ace_string">"id: "</span>.<span class="ace_variable">$id</span>.<span class="ace_string">"br/&gt;"</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 15px; top: 360px;"><div class="ace_line" style="height: 15px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_support ace_function">echo</span> <span class="ace_string">"email: "</span>.<span class="ace_variable">$email</span>.<span class="ace_string">"br/&gt;"</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 15px; top: 375px;"><div class="ace_line" style="height: 15px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_support ace_function">echo</span> <span class="ace_string">"celular: "</span>.<span class="ace_variable">$celular</span>.<span class="ace_string">"br/&gt;"</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 15px; top: 390px;"><div class="ace_line" style="height: 15px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_support ace_function">echo</span> <span class="ace_string">"senha: "</span>.<span class="ace_variable">$senha</span>.<span class="ace_string">"br/&gt;"</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 15px; top: 405px;"><div class="ace_line" style="height: 15px;"><span class="ace_indent-guide">    </span>    <span class="ace_paren ace_rparen">}</span></div></div><div class="ace_line_group" style="height: 15px; top: 420px;"><div class="ace_line" style="height: 15px;">    <span class="ace_paren ace_rparen">}</span></div></div><div class="ace_line_group" style="height: 15px; top: 435px;"><div class="ace_line" style="height: 15px;">    </div></div><div class="ace_line_group" style="height: 15px; top: 450px;"><div class="ace_line" style="height: 15px;">    <span class="ace_variable">$login</span><span class="ace_keyword ace_operator">=</span><span class="ace_string">"xyz@xyz.com.br"</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 15px; top: 465px;"><div class="ace_line" style="height: 15px;">    </div></div><div class="ace_line_group" style="height: 15px; top: 480px;"><div class="ace_line" style="height: 15px;">    <span class="ace_variable">$query</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_string">'SELECT * FROM '</span>.<span class="ace_variable">$usertable</span>.<span class="ace_string">' where email="'</span>.<span class="ace_variable">$login</span>.<span class="ace_string">'" or celular="'</span>.<span class="ace_variable">$login</span>.<span class="ace_string">'"'</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 15px; top: 495px;"><div class="ace_line" style="height: 15px;">    </div></div><div class="ace_line_group" style="height: 15px; top: 510px;"><div class="ace_line" style="height: 15px;">    <span class="ace_support ace_function">echo</span> <span class="ace_variable">$query</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 15px; top: 525px;"><div class="ace_line" style="height: 15px;">    <span class="ace_variable">$result</span><span class="ace_keyword ace_operator">=</span> <span class="ace_support ace_function">mysqli_query</span><span class="ace_paren ace_lparen">(</span><span class="ace_variable">$con</span><span class="ace_punctuation ace_operator">,</span> <span class="ace_variable">$query</span><span class="ace_paren ace_rparen">)</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 15px; top: 540px;"><div class="ace_line" style="height: 15px;">    <span class="ace_support ace_function">print_r</span><span class="ace_paren ace_lparen">(</span><span class="ace_variable">$result</span><span class="ace_paren ace_rparen">)</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 15px; top: 555px;"><div class="ace_line" style="height: 15px;"><span class="ace_support ace_php_tag">?&gt;</span></div></div><div class="ace_line_group" style="height: 15px; top: 570px;"><div class="ace_line" style="height: 15px;"></div></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer ace_animate-blinking"><div class="ace_cursor" style="display: block; transform: translate(4px, 345px); width: 7px; height: 15px; animation-duration: 1000ms;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="width: 15px; bottom: 0px;"><div class="ace_scrollbar-inner" style="width: 15px; height: 585px;">&nbsp;</div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 15px; left: 47px; right: 10px;"><div class="ace_scrollbar-inner" style="height: 15px; width: 812px;">&nbsp;</div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;">הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה</div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; font-optical-sizing: inherit; font-kerning: inherit; font-feature-settings: inherit; font-variation-settings: inherit; overflow: visible;"></div></div></div>
                <!-- ngInclude: --><div ng-include="" data-src="&#39;error-bar&#39;" class="clearfix ng-scope">
  <div class="label label-danger error-msg pull-left animated fadeIn ng-scope ng-hide" ng-show="apiMiddleware.apiHandler.error">
    <i class="glyphicon glyphicon-remove-circle"></i>
    <span class="ng-binding"></span>
...
<div class="modal animated fadeIn ng-scope" id="uploadfiledialog" style="display: none;">
  <div class="modal-dialog">
    <div class="modal-content">
        <form ng-submit="uploadFiles()" class="ng-pristine ng-valid ng-submitted">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">
                  <span aria-hidden="true">×</span>
                  <span class="sr-only ng-binding">Close</span>
            ...
            <div class="modal-body">
              <label class="radio ng-binding">
                ...
                <b class="ng-binding">/public_html/projeto003</b>
              </label>
...
<script type="text/ng-template" id="selected-files-msg" class="ng-scope">
  ...
  <div ng-show="temps.length > 1 &amp;&amp; showDetails">
    ...
    <!-- ngInclude: config.tplPath + '/item-context-menu.html' --><div ng-include="config.tplPath + &#39;/item-context-menu.html&#39;" class="ng-scope"><div id="context-menu" class="dropdown clearfix animated fast fadeIn ng-scope" style="left: 461px; top: 159px; display: none;">
